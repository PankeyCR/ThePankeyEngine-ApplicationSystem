...
#ifndef DefaultEventManager_hpp
	#define DefaultEventManager_hpp

	#include "InvokeRawMap.hpp"
	#include "Note.hpp"

	#if defined(pankey_Log) && (defined(DefaultEventManager_Log) || defined(pankey_Global_Log) || defined(pankey_ApplicationSystem_Log))
		#include "Logger_status.hpp"
		#define DefaultEventManagerLog(status,method,mns) pankey_Log(status,"DefaultEventManager",method,mns)
	#else
		#define DefaultEventManagerLog(status,method,mns)
	#endif
